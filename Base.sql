...
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Google Colaboratory (Colab)', 'Codage / Développement', 'https://colab.research.google.com/?hl=fr', '?', 'Colab est une plateforme très pratique pour exécuter du code Python sans avoir besoin d''installer Python localement. Elle est souvent utilisée pour les démonstrations, les TP et les projets en Machine Learning car elle donne accès à des ressources de calcul gratuites (CPU, GPU, TPU).', 'a) Se connecter à Colab avec son compte Google
b) Créer un nouveau notebook
c) Commencer à coder en Python directement dans le navigateur.');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Environnements virtuels', 'Hyperviseurs', '???', '?', 'Machines virtuelles', 'OPTION I : Utilisation d''un hyperviseur
...
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Environnements virtuels', 'Containers', 'https://www.docker.com/', '?', 'Containers Docker', 'a) Installer Docker
...
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Hack The Box', 'Cyber sécurité', 'https://www.hackthebox.com/', '?', 'Hack The Box est une plateforme de cybersécurité réputée pour ses challenges de type "capture de drapeaux" (CTF). Elle propose des machines virtuelles à attaquer légalement pour s''entraîner au hacking éthique.', 'Créer un compte standard sur le site via le lien indiqué');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('AWS', 'Cloud provider', 'https://signin.aws.amazon.com/signup?request_type=register', '?', 'Fournisseur Cloud', '?');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('AWS Academy', 'Formations en ligne', 'https://aws.amazon.com/fr/training/awsacademy/', '?', 'Plateforme d''AWS de formations en ligne', '?');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Azure', 'Cloud provider', 'https://azure.microsoft.com/en-us', '?', 'Fournisseur Cloud', '?');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Integral Calculator', 'Mathématiques', 'https://www.integral-calculator.com/', '?', 'Calcul d''intégrales en ligne', '?');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('eMathHelp', 'Mathématiques', 'https://www.emathhelp.net/en/', '?', 'Résolution de problèmes mathématiques, étape par étape', '?');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('MultisimLive', 'Electronique', 'https://www.multisim.com/', '?', 'Simulation de programmation de cartes electroniques', '?');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('MATLAB & Simulink (MathWorks)', 'Mathématiques', 'https://fr.mathworks.com/products/matlab/student.html', '?', 'Calcul numérique / Analyse de données', 'Un accompagnement clair et détaillé est proposé dans les cours utilsant l''outil');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Patchwork3D & AccelVR (Lumiscaphe)', 'Réalité virtuelle / augmentée', 'https://resources.lumiscaphe.com/Software_Suite/2023/en/accel-vr.html <br>https://resources.lumiscaphe.com/Software_Suite/2023/en/patchwork-3d.html', '?', 'Modélisation 3D / Rendu RV', 'S''informer auprès de l''enseignant');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Kaggle', 'Data Science', 'https://www.kaggle.com/', '?', 'Kaggle est une plateforme web qui fournit des outils et des ressources puissants pour aider à progresser en Data Science. Vous trouverez plus de 50 000 jeux de données publics et 400 000 notebooks publics disponibles pour tous.', 'S''informer auprès de l''enseignant');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Notion', 'Gestion de projets et collaboration', 'https://www.notion.so/fr-fr', '?', 'Notion est une application/plateforme de prise de notes, de gestion de projet et de collaboration. Notion est conçu pour permettre aux utilisateurs d''organiser leurs informations de manière flexible, en utilisant une variété de formats tels que des notes, des bases de données relationnelles, des listes de tâches, des calendriers et des tableaux, le tout dans un seul espace de travail intégré.', 'S''informer auprès de l''enseignant');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Trello', 'Gestion de projets et collaboration', 'https://trello.com/home', '?', 'Trello est une plateforme de gestion de projet très visuelle et intuitive. Elle est idéale pour les travaux de groupe, car elle permet de suivre facilement l''avancement des tâches et de communiquer efficacement entre les membres de l''équipe.', 'a) Créer un compte (version gratuite)
...
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Marp', 'Génération de documents', 'https://marp.app/', '?', 'Création de slides à prtir de documents Markdown', 'La documentation sur le site officiel est très détaillée et suffisamment précise pour permettre une prise en main autonome');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('LaTeX', 'Génération de documents', 'https://www.latex-project.org/', '?', 'LaTeX est un langage et un système de composition de documents', 'La documentation sur le site officiel est très détaillée et suffisamment précise pour permettre une prise en main autonome');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Material for mkdocs', 'Génération de documents', 'https://squidfunk.github.io/mkdocs-material/', '?', 'Création de documentation (de code)', 'La documentation sur le site officiel est très détaillée et suffisamment précise pour permettre une prise en main autonome');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Looping', 'Bases de données', 'https://www.looping-mcd.fr/', '?', 'Modélisation conceptuelle de données', 'Télécharger et installer');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('MongoDB Compass', 'Bases de données', 'https://www.mongodb.com/products/tools/compass', '?', 'GUI pour MongoDB', 'Télécharger et installer');
INSERT INTO tool (Titre, Domaine, Lien, Description_simple, Description_detaillee, Acces) VALUES ('Wireshark', 'Réseaux', 'https://www.wireshark.org/', '?', 'Wireshark est un analyseur de paquets libre et gratuit. Il est notamment utilisé dans le dépannage et l’analyse de réseaux informatiques et le développement de protocoles.', 'Télécharger et installer');
